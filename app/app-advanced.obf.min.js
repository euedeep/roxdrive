...
// const lebar = 0
  ...
  function file(path) {
      ...
      $('#content').html(`<div id="spinner" class="d-flex justify-content-center" style="height: 150px"><div class="spinner-border ${UI.loading_spinner_class} m-5" role="status"><span class="sr-only"></span></div></div>`);
