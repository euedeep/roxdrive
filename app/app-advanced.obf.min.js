...
function file_others(path) {
  ...
  <div class="input-group mb-4">
    ...
    <div class="btn-group text-center">
        ...
        <button id="donlotother" type="button" class="btn btn-primary dropdown-toggle-split dropdown-toggle" data-bs-display="static" data-bs-auto-close="true" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
 		<i class="fas fa-angle-right fa-fade" aria-hidden="true"></i>
		<span class="sr-only"></span>
        </button>
        <div class="dropdown-menu dropdown-menu-dark" aria-labelledby="donlotother">
...
function file_code(path) {
  ...
  <div class="input-group mb-4">
    ...
    <div class="btn-group text-center">
        <a href="${url}" type="button" class="btn btn-primary">Download</a>
        <button id="donlotfilecode" type="button" class="btn btn-primary dropdown-toggle-split dropdown-toggle" data-bs-display="static" data-bs-auto-close="true" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <i class="fas fa-angle-right fa-fade" aria-hidden="true"></i>
		<span class="sr-only"></span>
        </button>
        <div class="dropdown-menu dropdown-menu-dark" aria-labelledby="donlotfilecode">
          <a class="dropdown-item" href="intent:${url}#Intent;component=idm.internet.download.manager/idm.internet.download.manager.Downloader;S.title=${decodename};end">1DM (Free)</a>
          <a class="dropdown-item" href="intent:${url}#Intent;component=idm.internet.download.manager.adm.lite/idm.internet.download.manager.Downloader;S.title=${decodename};end">1DM (Lite)</a>
          <a class="dropdown-item" href="intent:${url}#Intent;component=idm.internet.download.manager.plus/idm.internet.download.manager.Downloader;S.title=${decodename};end">1DM+ (Plus)</a>
        </div>
...
function file_video(path) {
  ...
  <div class="btn-group text-center">
      <a href="${url}" type="button" class="btn btn-primary">Download</a>
      <button id="donlotvideo" type="button" class="btn btn-primary dropdown-toggle-split dropdown-toggle" data-bs-display="static" data-bs-auto-close="true" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      <i class="fas fa-angle-right fa-fade" aria-hidden="true"></i>
	  <span class="sr-only"></span>
      </button>
      <div class="dropdown-menu dropdown-menu-dark" aria-labelledby="donlotvideo">
...
function file_audio(path) {
  ...
  <div class="input-group mb-4">
    ...
    <div class="btn-group text-center">
        <a href="${url}" type="button" class="btn btn-primary">Download</a>
        <button id="donlotaudio" type="button" class="btn btn-primary dropdown-toggle-split dropdown-toggle" data-bs-display="static" data-bs-auto-close="true" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <i class="fas fa-angle-right fa-fade" aria-hidden="true"></i>
		<span class="sr-only"></span>
        </button>
        <div class="dropdown-menu dropdown-menu-dark" aria-labelledby="donlotaudio">
          <a class="dropdown-item" href="intent:${url}#Intent;component=idm.internet.download.manager/idm.internet.download.manager.Downloader;S.title=${decodename};end">1DM (Free)</a>
          <a class="dropdown-item" href="intent:${url}#Intent;component=idm.internet.download.manager.adm.lite/idm.internet.download.manager.Downloader;S.title=${decodename};end">1DM (Lite)</a>
          <a class="dropdown-item" href="intent:${url}#Intent;component=idm.internet.download.manager.plus/idm.internet.download.manager.Downloader;S.title=${decodename};end">1DM+ (Plus)</a>
        </div>
...
function file_pdf(path) {
  ...
  <div class="input-group mb-4">
    ...
    <div class="btn-group text-center">
        <a href="${url}" type="button" class="btn btn-primary">Download</a>
        <button id="donlotpdf" type="button" class="btn btn-primary dropdown-toggle-split dropdown-toggle" data-bs-display="static" data-bs-auto-close="true" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <i class="fas fa-angle-right fa-fade" aria-hidden="true"></i>
		<span class="sr-only"></span>
        </button>
        <div class="dropdown-menu dropdown-menu-dark" aria-labelledby="donlotpdf">
          <a class="dropdown-item" href="intent:${url}#Intent;component=idm.internet.download.manager/idm.internet.download.manager.Downloader;S.title=${decodename};end">1DM (Free)</a>
          <a class="dropdown-item" href="intent:${url}#Intent;component=idm.internet.download.manager.adm.lite/idm.internet.download.manager.Downloader;S.title=${decodename};end">1DM (Lite)</a>
          <a class="dropdown-item" href="intent:${url}#Intent;component=idm.internet.download.manager.plus/idm.internet.download.manager.Downloader;S.title=${decodename};end">1DM+ (Plus)</a>
        </div>
...
function file_image(path) {
  ...
  <div class="input-group mb-4">
    ...
    <div class="btn-group text-center">
        <a href="${url}" type="button" class="btn btn-primary">Download</a>
        <button id="donlotimage" type="button" class="btn btn-primary dropdown-toggle-split dropdown-toggle" data-bs-display="static" data-bs-auto-close="true" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <i class="fas fa-angle-right fa-fade" aria-hidden="true"></i>
		<span class="sr-only"></span>
        </button>
        <div class="dropdown-menu dropdown-menu-dark" aria-labelledby="donlotimage">
          <a class="dropdown-item" href="intent:${url}#Intent;component=idm.internet.download.manager/idm.internet.download.manager.Downloader;S.title=${decodename};end">1DM (Free)</a>
          <a class="dropdown-item" href="intent:${url}#Intent;component=idm.internet.download.manager.adm.lite/idm.internet.download.manager.Downloader;S.title=${decodename};end">1DM (Lite)</a>
          <a class="dropdown-item" href="intent:${url}#Intent;component=idm.internet.download.manager.plus/idm.internet.download.manager.Downloader;S.title=${decodename};end">1DM+ (Plus)</a>
        </div>
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@sweetalert2/themes@5.0.2/wordpress-admin/wordpress-admin.min.css">`;
	...
	$('a[id="navbarDropdown"]').click(function() {
		if (
			...
			$('div.dropdown-menu').slideUp(200); //slide up all the sub divs
			$('a[id="navbarDropdown"]')
				.find($('.fas'))
	...
	$(document).click(function(e) {
		if (!$('a[id="navbarDropdown"]').is(e.target) && !$('a[id="navbarDropdown"] i').is(e.target)) {
			...
			$('div.dropdown-menu').slideUp(200); // slide all up
			if (
				$('a[id="navbarDropdown"]')
					.find($('.fas'))
...
function dialogPass() {
	var konten = `<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11.2.0/build/styles/atom-one-dark-reasonable.min.css">
	<script src="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11.2.0/build/highlight.min.js"></script>`;
...
function copy2Clipboard() {
	...
	clipboard.on('success', function(e) {
		...
		$('#copy-check')
			.removeClass('d-none')
			.addClass('d-inline-block');
		//$('#copy-clippy').toggleClass('d-inline-block d-none');
		//$('#copy-check').toggleClass('d-none d-inline-block');
		//gantiIcon('.tombol-copay', 'fa-clipboard-check').fadeOut(250);
		//$('#tombol-copy').addClass('copied');
...
function hideTooltip(btn) {
	setTimeout(function() {
		...
		$('#copy-clippy')
			.removeClass('d-none')
			.addClass('d-inline-block');
		//$('#tombol-copy').attr('data-bs-original-title', 'Copy to clipboard');
		//$('#tombol-copy').removeClass('copied');
		//gantiIcon('.tombol-copay', 'fa-clipboard fa-lg').fadeIn(250);
		//$('#tombol-copy').fadeOut(250);
	}, 2000);
}
/**
...
function navAnimasi() {
	$('#navbarDropdown').click(function() {
		if (
			...
			$('div[class="dropdown-menu"]').slideUp(200); //slide up all the sub divs
			$('#navbarDropdown')
				.find($('.fas'))
				.removeClass('fa-rotate-180 pe-1'); // bring all iconsto normal
			$(this)
	...
	$(document).click(function(e) {
		if (!$('#navbarDropdown').is(e.target) && !$('#navbarDropdown i').is(e.target)) {
			//if clicked other than 'a' or 'i' tag
			$('div[class="dropdown-menu"]').slideUp(200); // slide all up
			if (
				$('#navbarDropdown')
					.find($('.fas'))
					.hasClass('fa-rotate-180 pe-1')
