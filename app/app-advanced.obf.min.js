...
function nav(path) {
  ...
  <div class="input-group input-group-sm bg-light rounded">
  <input class="form-control me-0" name="q" type="search" placeholder="Search" aria-label="Search" value="${search_text}" required>
