...
function nav(path) {
  ...
  <form class="d-flex" method="get" action="/${cur}:search">
  	<div class="input-group ">
  		...
  		<button class="btn ${UI.search_button_class}" aria-pressed="true" onclick="if($('#search_bar_form>input').val()) $('#search_bar_form').submit();" type="submit"><i class="fas fa-search"></i></button>
  	</div>
  </form>
  </div>
  </div>
