...
function list(path) {
  let content = `
    <!-- iklan awal-->
    <div id="bosque-pix" class="resp-container">    
    </div>
    <!-- akhir -->
...
$(() => {
  ...
  injekAds()
  adjustIframes()
  setTimeout(reloadIFrame, 300000)
...
function injekAds() {
  ...
  if (mini) {
    ...
    $('<iframe>', {
      ...
      width: 320,
      height: 50,
    }).appendTo('div#bosque-pix')
  } else if (medium) {
    // sedang screens
    // if ($('#myDiv').length) {
      /* Do something */
    // }
    $minBig.is('html *') // returns true
    $minBig.remove()
    $('<iframe>', {
