...
function dialogPass() {
	...
	<script src="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11.2.0/build/highlight.min.js"></script>`;
	var clippy = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="copy-clippy" aria-hidden="true" role="img" width="1em" height="1em" class="tombol-copay tombol-copay-clippy" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
	...
	var check = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="copy-check" aria-hidden="true" role="img" width="1em" height="1em" class="tombol-copay tombol-copay-sukses d-none" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
	...
	Swal.fire({
		title: '',
		html: `<div class="posisi-relatif"><pre class="highlight p-0"><code id="targetCopy" class="language-rib pass-area">roxdrive</code></pre>
		${clippy}
		${check}
		<button id="tombol-copy" class="tombol-copay tooltipped-no-delay p-1" onclick="copy2Clipboard()" data-clipboard-target="#targetCopy"></button></div>`,
...
function copy2Clipboard() {
	...
	clipboard.on('success', function(e) {
		setTooltip('Copied!');
		$('#copy-clippy').css('display', 'none');
		$('#copy-check').css('display', 'block');
...
function hideTooltip() {
	setTimeout(function() {
		...
		$('#copy-check').css('display', 'none');
		$('#copy-clippy').css('display', 'block');
