...
function nav(path) {
	...
	html += `<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">${drive_name}<span class="fas fa-chevron-down"></span></a><div class="dropdown-menu" aria-labelledby="navbarDropdown">`;
	names.forEach((name, idx) => {
		html += `<a class="dropdown-item" href="/${idx}:/">${name}</a>`;
	});
	html += `</div></li>`;

	html += `<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">${UI.nav_link_3}<span class="fas fa-chevron-down"></span></a><div class="dropdown-menu" aria-labelledby="navbarDropdown"><a class="dropdown-item" href="/"><span class="fas fa-chevron-right"></span>Home</a>`;
...
function utc2delhi(utc_datetime) {
	...
	return (
		...
		'-' +
		year +
		'<span class="fas fa-ellipsis-v fa-xs"></span>' +
...
function dialogPass() {
	...
	Swal.fire({
		...
		<pre class="highlight position-relative p-1 mb-0 top-0 end-0">
		<code id="targetCopy" class="language-rib pass-area">roxdrive</code></pre>		
		...
		focusConfirm: false,
		confirmButtonText: '<span class="fas fa-thumbs-up fa-lg" style="color:#383c3f"></span>',
		confirmButtonAriaLabel: 'Thumbs up, great!',
		cancelButtonText: '<span class="fas fa-thumbs-down" style="color:#383c3f"></span>',
...
function copy2Clipboard() {
	...
	clipboard.on('error', function() {
		setTooltip('Failed!');
		//gantiIcon('.tombol-copay', 'fa-times-circle fa-lg').fadeOut(250);
		hideTooltip();
	});
}
...
function hideTooltip() {
	setTimeout(function() {
		//$('#tombol-copy').tooltip('hide');
		$('#copy-check').toggleClass('d-inline-block d-none');
		$('#copy-clippy').toggleClass('d-none d-inline-block');
