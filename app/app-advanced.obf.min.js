...
function list(path) {
    ...
    <nav style="/*! --bs-breadcrumb-divider: '>'; */" aria-label="breadcrumb">
      <ol class="breadcrumb mb-0" id="folderne"><li class="breadcrumb-item"><a href="/">Home</a><i class="fas fa-chevron-right fa-xs"></i></li>`;
	var navlink = '';
	...
	if (navarray.length > 1) {
		...
		for (var i in navarray) {
			...
			content += `<li class="breadcrumb-item"><a href="${p}">${n}</a><i class="fas fa-chevron-right fa-xs"></li>`;
		}
	}
	content += `</ol>
    </nav>
...
function dialogPass() {
	var konten = `<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/prism/1.24.1/themes/prism-tomorrow.min.css" integrity="sha512-vswe+cgvic/XBoF1OcM/TeJ2FW0OofqAVdCZiEYkd6dwGXthvkSFWOoGGJgS2CW70VK5dQM5Oh+7ne47s74VTg==" crossorigin="anonymous" referrerpolicy="no-referrer" />
	<script src="https://cdnjs.cloudflare.com/ajax/libs/prism/1.24.1/prism.min.js" integrity="sha512-axJX7DJduStuBB8ePC8ryGzacZPr3rdLaIDZitiEgWWk2gsXxEFlm4UW0iNzj2h3wp5mOylgHAzBzM4nRSvTZA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>`;
	Swal.fire({
		title: '',
		html:
			'<div class="posisi-relatif"><pre class="language-ada"><code id="targetCopy" class="pass-area">roxdrive</code></pre><button id="tombol-copy" class="tombol-copay fas fa-clipboard fa-lg" onclick="copy2Clipboard()" data-clipboard-target="#targetCopy"></button></div>',
