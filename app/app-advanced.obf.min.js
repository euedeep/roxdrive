...
const shadowify = function(e) {
	...
	if (remt) {
		res = '0rem 0rem .' + remt[2] / 30 + 'rem';
		console.info('remt');
	} else if (em) {
		res = '0em 0em ' + em[1] / 30 + 'em';
		console.info('em');
	} else if (rem) {
		res = '0rem 0rem ' + rem[1] / 30 + 'rem';
		console.info('rem');
	} else if (emt) {
		res = '0em 0em .' + emt[2] / 30 + 'em';
		console.info('emt');
	} else if (px) {
		res = '0px 0px ' + px[1] / 30 + 'px';
		console.info('px');
	}
	//$(e).css('text-shadow', '0 0 ' + fsize[1] / 30 + 'px rgba(' + rgba[1] + ',' + rgba[2] + ',' + rgba[3] + ',0.2)');
	$(e).css('text-shadow', `${res} rgba(${r},${g},${b},0.2)`);
};
