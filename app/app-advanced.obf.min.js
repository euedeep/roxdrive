...
function dialogPass() {
	...
	Swal.fire({
		title: '',
		html:
			'<div class="posisi-relatif"><pre class="highlight p-0"><code id="targetCopy" class="language-rib pass-area">roxdrive</code></pre><button id="tombol-copy" class="tombol-copay-pass tombol-copay-pass-ikon p-1" onclick="copy2Clipboard()" data-clipboard-target="#targetCopy"></button></div>',
