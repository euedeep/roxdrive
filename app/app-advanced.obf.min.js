...
function nav(path) {
  ...
  <form class="d-flex me-md-4" method="get" action="/${cur}:search">
...
function list(path) {
	var content = `<div class="container">${UI.fixed_header ? '<br>' : ''}
      ...
      <div class="${UI.path_nav_alert_class} d-flex align-items-center mb-0 pb-0 pt-1 pb-1 ps-2" role="alert" style="/*! margin-bottom: 0; */ /*! padding-bottom: 0rem; */">
	...
	content += `</ol>
      ...
      <div id="list" class="list-group text-break list-group-bored">
      </div>
...
function append_files_to_list(path, files) {
	...
	for (i in files) {
		...
		if (item['mimeType'] == 'application/vnd.google-apps.folder') {
			...
			c += ' view';
			//}
			html += '<div class="list-group-item list-group-item-action list-item">';
		...
		if (item['mimeType'] == 'application/vnd.google-apps.folder') {
			...
			html += `<a class="text-body" style="/*! color: ${UI.css_a_tag_color}; */" ${
				UI.search_all_drives
					...
					: 'onclick="onSearchResultItemClick(this)" data-bs-toggle="modal" data-bs-target="#SearchModel" id="' + item['id'] + '" teamDriveId="' + item['teamDriveId'] + '"'
			} gd-type="${item.mimeType}" class="list-group-item list-group-item-action list-item">`;
