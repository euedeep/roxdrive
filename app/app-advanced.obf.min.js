...
function navAnimasi() {
	$('a.nav-link.dropdown-toggle').click(function() {
		if (
			...
			$('a.nav-link.dropdown-toggle')
				.find($('.fa'))
				.removeClass('fa-rotate-180'); // bring all iconsto normal
			$(this)
				.find($('.fa'))
				.addClass('fa-rotate-180'); // rotate icon by 180
			if (
				$(this)
					.next()
					.is(':visible')
				...
				$('a.nav-link.dropdown-toggle')
					.find($('.fa'))
					.removeClass('fa-rotate-180'); // if yes then undo icon rotation
				$(this)
					.next()
	...
	$(document).click(function(e) {
		if (!$('a.nav-link.dropdown-toggle').is(e.target) && !$('a.nav-link.dropdown-toggle i').is(e.target)) {
			//if clicked other than 'a' or 'i' tag
			$('div.dropdown-menu').slideUp(200); // slide all up
			if (
				$('a.nav-link.dropdown-toggle')
					.find($('.fa'))
					.hasClass('fa-rotate-180')
			) {
				$(this)
					.find($('.fa'))
					.removeClass('fa-rotate-180'); //remove all rotation
			}
		}
	});
}
