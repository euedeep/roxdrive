...
function dialogPass() {
	Swal.fire({
		title: '',
		html:
			'<div><pre><code id="targetCopy" class="code-area">roxdrive</code></pre><span id="tombol-copy" class="tombol-copay fas fa-clipboard" onclick="copy2Clipboard()" data-clipboard-target="#targetCopy"></span></div>',
		showCloseButton: false,
		showCancelButton: false,
		focusConfirm: false,
		confirmButtonText: '<span class="fas fa-thumbs-up" style="color:#383c3f"></span>',
...
function copy2Clipboard() {
	...
	clipboard.on('success', function(e) {
		setTooltip('Copied!');
		gantiIcon('#tombol-copy', 'fa-clipboard-check').fadeOut(250);
	...
	clipboard.on('error', function() {
		setTooltip('Failed!');
		gantiIcon('#tombol-copy', 'fa-times-circle').fadeOut(250);
		hideTooltip();
	});
}
...
function hideTooltip() {
	setTimeout(function() {
		...
		gantiIcon('#tombol-copy', 'fa-clipboard').fadeIn(250);
		//$('#tombol-copy').fadeOut(250);
	}, 1000);
}
/**
 * @param {string} id - element id yang akan diganti
