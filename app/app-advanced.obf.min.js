...
function list(path) {
  let content = `
    ...
    <iframe id="kuwlFrame" src="//strangelyfaintestgreenhouse.com/watchnew?key=d7fb8ebfd2973fc6fc22b1d22f2d33ed" width="${ukuran.width}" height="${
    ukuran.height
...
function render_search_result_list() {
  const content = `
    <!-- iklan awal-->
    <div id="bosque" class="mantul">
    <iframe id="kuwlFrame" src="//strangelyfaintestgreenhouse.com/watchnew?key=d7fb8ebfd2973fc6fc22b1d22f2d33ed" width="${ukuran.width}" height="${ukuran.height}" frameborder="0" scrolling="no"></iframe>
    </div>
    <!-- akhir -->
...
function injekAds() {
  ...
  if (mini) {
    ...
    // $rem.remove()
    $('#kuwlFrame').attr('src', '//strangelyfaintestgreenhouse.com/watchnew?key=c747be716129596ba5e7f519fbe27152')
    // $('<iframe>', {
    ...
    //   width: 320,
    //   height: 50,
    // }).appendTo('d' + 'iv#bosque')
    $('<script async="async" data-cfasync="false" src="//strangelyfaintestgreenhouse.com/93535642da474b1fa567c29830789fb3/invoke.js"></script>').insertBefore("#container-93535642da474b1fa567c29830789fb3")
  } else if (medium) {
    ukuran.width = 468
    ukuran.height = 60
    // sedang screens
    ...
    // $rem.is('html *') // returns true
    // $rem.remove()
    $('#kuwlFrame').attr('src', '//strangelyfaintestgreenhouse.com/watchnew?key=fe818d050b02c7c836cf99122f033764')
    // $('<iframe>', {
    ...
    // $rem.is('html *') // returns true
    // $rem.remove()
    $('#kuwlFrame').attr('src', '//strangelyfaintestgreenhouse.com/watchnew?key=d7fb8ebfd2973fc6fc22b1d22f2d33ed')
    // $('<iframe>', {
