...
function nav(path) {
  ...
  <button id="btn-cari" class="btn ${UI.search_button_class} waves-effect waves-light" onclick="if($('#search_bar_form>input').val()) $('#search_bar_form').submit();" type="submit"><i class="fas fa-search"></i></button>
  </div>
  </form>
  </div>
  </div>
...
function file_others(path) {
  ...
  <div class="card-body text-start">
    <div class="${UI.file_view_alert_class} text-dark" id="file_details" role="alert"><span class="text-warning ps-1 pe-1">Filename:</span>${obj.name}<br><span class="text-warning ps-1 pe-1">Size:</span>${size}</div>
  </div>
  <!-- iklan atas -->
  <div id="bosque" class="mantul pb-3">
    <iframe id="kuwlFrame" src="" width="0" height="0" frameborder="0" scrolling="no"></iframe>
  ...
  <div class="input-group mb-4">
    ...
    <div class="btn-group text-center dropend">
        <a href="${url}" type="button" class="btn btn-primary">Download</a>
        <button type="button" class="btn btn-primary waves-effect waves-light dropdown-toggle-split dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@sweetalert2/themes@5.0.2/wordpress-admin/wordpress-admin.min.css">`;
	...
	// cek mobile
	if (isMobile) {
		$('pre.highlight > button, pre.highlight > svg').addClass('d-inline-block');
	} else {
		$('pre.highlight > button, pre.highlight > svg').removeClass('d-inline-block');
	}
	aTags.forEach(link => {
