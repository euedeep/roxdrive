...
function nav(path) {
    ...
    <a class="navbar-brand" href="/${cur}:/">${UI.logo_image ? '<img border="0" alt="' + UI.company_name + '" src="' + UI.logo_link_name + '" height="' + UI.logo_height + '" width="' + UI.logo_width + '">' : UI.logo_link_name}</a>
  ...
  <form class="d-flex" method="get" action="/${cur}:search">
  	<div class="input-group ">
  		<input class="form-control me-2 input-1" name="q" type="search" placeholder="Search" aria-label="Search" value="${search_text}" required>
