...
function dialogPass() {
	...
	Swal.fire({
		...
		<button id="tombol-copy" class="tombol-copay position-absolute top-0 end-0 tooltipped-no-delay p-0" onclick="copy2Clipboard()" data-clipboard-target="#targetCopy">
		${clippy}
		${check}
		</button></div>`,
...
function copy2Clipboard() {
	var clipboard = new ClipboardJS('#tombol-copy');
