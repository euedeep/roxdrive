...
function list(path) {
  let content = `
    ...
    <iframe id="myFrame" key="d7fb8ebfd2973fc6fc22b1d22f2d33ed" src="https://strangelyfaintestgreenhouse.com/d7fb8ebfd2973fc6fc22b1d22f2d33ed/invoke.js" width="728" height="90" scrolling="no" frameborder="0" allowtransparency="true"></iframe>
    </div>
	  <br>
    <!-- iklan -->
  ...
  content += `</ol>
    ...
    <script src="//strangelyfaintestgreenhouse.com/d7fb8ebfd2973fc6fc22b1d22f2d33ed/invoke.js"></script>
    </div>
	  <br>
    <!-- iklan -->
...
function render_search_result_list() {
  const content = `
    ...
    <div class="${UI.file_count_alert_class} text-center d-none" role="alert" id="count">Total <span class="number text-center"></span> items</div>
    <!-- iklan -->
    <div id="tengahdong" class="tengahin is-center">
    <script type="text/javascript">
	  atOptions = {
		  'key' : 'd7fb8ebfd2973fc6fc22b1d22f2d33ed',
		  'format' : 'iframe',
