...
function nav(path) {
	...
	html += `<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">${drive_name}<span class="bx bx-chevron-down"></span></a><div class="dropdown-menu" aria-labelledby="navbarDropdown">`;
	names.forEach((name, idx) => {
		html += `<a class="dropdown-item" href="/${idx}:/">${name}</a>`;
	});
	html += `</div></li>`;

	html += `<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">${UI.nav_link_3}<span class="bx bx-chevron-down"></span></a><div class="dropdown-menu" aria-labelledby="navbarDropdown"><a class="dropdown-item" href="/"><span class="bx bx-chevron-right"></span>Home</a>`;
	...
	if (!model.is_search_page) {
		...
		if (arr.length > 1) {
			...
			for (var i in arr) {
				...
				html += `<a class="dropdown-item" href="${p}"><span class="bx bx-chevron-right"></span>${n}</a>`;
			}
		}
	}
  ...
  <button id="btn-cari" class="btn ${UI.search_button_class} waves-effect waves-light" onclick="if($('#search_bar_form>input').val()) $('#search_bar_form').submit();" type="submit"><span class="bx bx-search-alt"></span></button>
  </div>
  </form>
  </div>
  </div>
...
function append_search_result_to_list(files) {
	...
	for (i in files) {
		...
		if (item['mimeType'] == 'application/vnd.google-apps.folder') {
			...
			html += ` ${item.name}<span class="badge float-end csize p-1"> ${UI.display_size ? '<span class="badge bg-pink float-end p-1"> ' + item['size'] + ' </span>' : ''}${
				UI.display_time ? ' <span class="badge bg-info float-end p-1"> ' + item['modifiedTime'] + ' </span>' : ''
			}</a>`;
		}
	}
  ...
  <div class="input-group mb-4">
    ...
    <div class="btn-group text-center dropend">
        ...
        <button type="button" class="btn btn-primary waves-effect waves-light dropdown-toggle-split dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
 		  <span class="sr-only bx bxs-chevron-right bx-flashing"></span>
        </button>
