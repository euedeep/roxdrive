...
function nav(path) {
	...
	html += `<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">${drive_name}<span class="fas fa-chevron-down fa-sm ps-1"></span></a><div class="dropdown-menu" aria-labelledby="navbarDropdown">`;
	names.forEach((name, idx) => {
		html += `<a class="dropdown-item" href="/${idx}:/">${name}</a>`;
	});
	html += `</div></li>`;

	html += `<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">${UI.nav_link_3}<span class="fas fa-chevron-down fa-sm ps-1"></span></a><div class="dropdown-menu" aria-labelledby="navbarDropdown"><a class="dropdown-item" href="/"><span class="fas fa-chevron-right"></span>Home</a>`;
	...
	if (!model.is_search_page) {
		...
		if (arr.length > 1) {
			...
			for (var i in arr) {
				...
				html += `<a class="dropdown-item" href="${p}"><span class="fas fa-chevron-right"></span>${n}</a>`;
			}
		}
	}
	...
	html += `</div></li><li class="nav-item">
      ...
      <a onclick="dialogPass()" class="nav-link" data-href="${originLok}">Password</a>
    </li>`;
  ...
  <button id="btn-cari" class="btn ${UI.search_button_class} waves-effect waves-light" onclick="if($('#search_bar_form>input').val()) $('#search_bar_form').submit();" type="submit"><span class="fas fa-search"></span></button>
  </div>
  </form>
  </div>
  </div>
  ...
  <div class="input-group mb-4">
    ...
    <div class="btn-group text-center dropend">
        ...
        <button type="button" class="btn btn-primary waves-effect waves-light dropdown-toggle-split dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
 		  <span class="sr-only fas fa-chevron-right fa-fade"></span>
        </button>
...
function utc2delhi(utc_datetime) {
	...
	return (
		...
		'-' +
		year +
		'<span class="fas fa-ellipsis-v fa-xs pe-1 ps-1"></span>' +
...
function dialogPass() {
	...
	Swal.fire({
		...
		focusConfirm: false,
		confirmButtonText: '<span class="fas fa-thumbs-up fa-lg" style="color:#fff"></span>',
		confirmButtonAriaLabel: 'Thumbs up, great!',
		cancelButtonText: '<span class="fas fa-thumbs-down" style="color:#fff"></span>',
